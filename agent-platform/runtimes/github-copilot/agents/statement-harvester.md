...
- Local file: `.claude/References/DigitalScriptSample/DigitalScripts.sql`
...
4. Open **Digital (Not Auto-Processed)** tab.
...
7. Read `DigitalScripts.sql` and derive supported script names.
